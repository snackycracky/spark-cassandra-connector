...
class IncrementalCassandraChangesSpec extends ActorSpec {
  ...
  "cassandraRDD" must {
    "be refreshed with every access" in {
      ...
      val dictRDD = ssc.cassandraTable[(String, String)](KS, "dict").select("word", "translation")
